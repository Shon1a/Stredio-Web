...
/* lucide-animated's "layout-grid" icon (https://lucide-animated.com/r/layout-grid.json),
 * ported by hand for the same reason as FanIcon — see that file for the why. The four rects
 * chase each other one seat clockwise and back: 11 is the gap between the 7-wide squares at
 * x/y 3 and 14, so each rect lands exactly on its neighbour's seat.
 *
 * Controlled the same way as FanIcon: pass a ref and drive it with startAnimation/
